...
def count_handle(array)
  puts "Il y'a #{array.count} journalistes dans cette array !".red
  sleep 1
end

def digit_handle(array)
  count = 0
  array.each do |n|
    if n.count("0-9") > 0
      count += 1
...
while true
  question = 0
  puts  "Quelle est la question dons vous desirez la reponse ? :"
  puts "
